...
export default function Layout({ children, dashboard }) {
  ...
  // ⏳ WAIT while session is loading (VERY IMPORTANT)
  ...
  return (
    <div className="min-h-screen flex bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-md flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          <Link href="/dashboard" className="block px-4 py-2 rounded hover:bg-blue-100">
            Dashboard Home
          </Link>
          ...
          {isAdmin && (
            <>
              <Link href="/dashboard/users" className="block px-4 py-2 rounded hover:bg-blue-100">
                Users
              </Link>
              <Link href="/dashboard/add-user" className="block px-4 py-2 rounded hover:bg-blue-100">
                Add User
              </Link>
            </>
          )}

          <Link href="/dashboard/blogs" className="block px-4 py-2 rounded hover:bg-blue-100">
            Blogs
          </Link>

          <Link href="/dashboard/add-blog" className="block px-4 py-2 rounded hover:bg-blue-100">
            Add New Blog
          </Link>

          <Link href="/dashboard/profile" className="block px-4 py-2 rounded hover:bg-blue-100">
            Profile
          </Link>
